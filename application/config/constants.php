...
define('PLUGIN_ROOT', dirname(FCPATH).'/courtwork/static/plugins');
define('CSS_ROOT', dirname(FCPATH).'/courtwork/static/assets/css');
define('JS_ROOT', dirname(FCPATH).'/courtwork/static/assets/js');
