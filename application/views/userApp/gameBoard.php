    ...
    <main role="main">
      ...
      <article>
        <header class="section background-dark">
          <div class="line">
            <h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1">경기 검색</h1>
            <p class="margin-bottom-0 text-size-16">지역, 시간, 경기 타입에 따른 경기 목록들을 보여줍니다. 마음에 드는 경기가 없는경우 경기를 등록 가능합니다.</p>
          </div>
        </header>
